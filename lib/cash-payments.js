...
import { readCashView } from './cash-navigation.js';
...
export const buildCashJournalHref = ({
  ...
  if (view !== undefined) parameters.set('vue', readCashView(view));
...
export const validateCashJournalHref = (value) => {
  ...
  return buildCashJournalHref({
    ...
    view: searchParams.vue === undefined ? undefined : readCashView(searchParams.vue),
  });
};
