...
const serializeSalePriceAtLoading = (salePrice) => {
  ...
  return {
    ...
    ...(salePrice.packaging
      ? {
          packaging: {
            amountInCentimes: salePrice.packaging.amountInCentimes,
            currency: salePrice.packaging.currency,
            label: salePrice.packaging.label,
            packagingId: salePrice.packaging.packagingId?.toString?.() ?? null,
            quantity: salePrice.packaging.quantity,
            taxIncluded: salePrice.packaging.taxIncluded,
          },
        }
      : {}),
  };
