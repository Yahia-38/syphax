export const PERMISSIONS = Object.freeze([
  ...
  { key: 'stock.valuation.read', domain: 'Stock', label: 'Consulter la valorisation et les coûts d’achat' },
  { key: 'profitability.read', domain: 'Rentabilité', label: 'Consulter' },
  ...
  {
    key: 'cash.withdrawals.create',
    domain: 'Caisse',
    label: 'Retirer des espèces',
  },
  ...
  { key: 'deliverers.objectives.read', domain: 'Livreurs', label: 'Consulter les objectifs' },
  { key: 'deliverers.objectives.update', domain: 'Livreurs', label: 'Définir et modifier les objectifs' },
  {
    key: 'deliverers.credit-limit.read',
    domain: 'Livreurs',
    label: 'Consulter la limite de crédit',
  },
  {
    key: 'deliverers.credit-limit.update',
    domain: 'Livreurs',
    label: 'Modifier la limite de crédit',
  },
  {
  ...
  },
  {
    key: 'tours.cancel',
    domain: 'Tournées',
    label: 'Annuler une tournée en préparation',
  },
  {
  ...
  {
    key: 'tours.expenses.read',
    domain: 'Tournées',
    label: 'Consulter les frais avancés',
  },
  {
    key: 'tours.expenses.declare',
    domain: 'Tournées',
    label: 'Déclarer les frais avancés',
  },
  {
    key: 'tours.close',
    domain: 'Tournées',
    label: 'Terminer une tournée comptée',
  },
  {
