...
export const buildDelivererToursHref = ({
  ...
  if (['ensemble', 'objectifs', 'tournees', 'identification'].includes(section)) {
...
export const validateTourReturnHref = (value, delivererId) => {
  ...
  if (
    ...
    || (destination.searchParams.has('section')
      && !['ensemble', 'objectifs', 'tournees', 'identification'].includes(destination.searchParams.get('section')))
  ...
  return buildDelivererToursHref({
    ...
    section: destination.searchParams.get('section'),
  });
};
