...
export const readDayRecapState = (
  searchParams = {},
...
export const buildDayAlerts = (records = [], { date = '', today = todayInAlgiers() } = {}) => {
...
const buildDayRecord = ({
  ...
  const record = {
    ...
    href: `/tournees/${tour._id.toString()}`,
...
export const getDayRecap = async ({
  ...
  const alerts = buildDayAlerts(records, { date: normalizedDate, today });
