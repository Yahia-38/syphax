...
import { updateProduct } from './actions.js';

const EditProductForm = ({ baseUnits, product }) => {
  ...
  return (
    <form action={formAction} className='space-y-6' key={state.revision}>
      ...
      <div className='flex flex-wrap gap-3 border-t border-slate-200 pt-6'>
        ...
        <Link
          className='rounded-lg border border-slate-300 bg-white px-4 py-2.5 font-medium text-slate-700 transition hover:border-slate-400 hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700'
