  ...
  return (
    <>
      {['designation', 'code'].map((name) => {
        ...
        return (
          <div className={creation && isCode ? styles.codeRow : undefined} key={name}>
            <div>
            ...
            {creation && isCode && <p className={styles.codeGuidance}>Choisissez une référence courte et facile à retrouver lors de la recherche.</p>}
          </div>
        );
      })}
      <div>
            ...
            <div className={styles.units}>
              {baseUnits.map((unit) => (
                <label className={styles.unit} key={unit.code}>
                  ...
                  <ProductIcon name={BASE_UNIT_ICONS[unit.code]} />
